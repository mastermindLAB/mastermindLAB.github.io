...
---
<img style="padding:0 15px; float: right;" src="{{ site.url }}{{ site.baseurl }}/images/face-recognision-blog.jpg" width="300" height="200"> what is the buzzword of _data science_, what does it literally mean, and why should business commence care? Let’s consider some of the most popular buzzwords and realize the actuality behind the hype.
